    ...
    return (
        <div className='bg-[#FDF3EA] py-[86px]' id='reviews'>
            ...
            <Container>
                ...
                <h2 className="font-['inter'] font-bold text-[63px] leading-[55px] tracking-[-2px] text-center mx-auto align-middle w-[70%]"
                ...
                <div className='w-[40%] my-10 '>
                    ...
                    <div className='border-2 rounded-2xl p-10 border-[#D1C7BE] relative mt-2'>
                        ...
                        <p className="font-['inter'] font-medium italic text-[16px] leading-[30px] tracking-[0%] align-middle">It's like Klaviyo for direct mail. The results are absolutely insane.</p>
                ...
                <div className='flex justify-end'>
                    ...
                    <div className='w-[40%] my-10 '>
                        ...
                        <div className='border-2 rounded-2xl p-10 border-[#D1C7BE] relative mt-2'>
                            <img src="/comma.png" alt="" className='absolute -top-4 bg-[#FDF3EA]' />
                            <p className="font-['inter'] font-medium italic text-[16px] leading-[30px] tracking-[0%] align-middle">PostPilot is our new weapon against sinking email engagement and rising PPC costs. The results and ROI have been outstanding. It’s now one of our core marketing channels to increase acquisition & LTV.</p>
                            <div className='flex justify-between'>
                ...
                <div className='w-[40%] my-10 '>
                    ...
                    <div className='border-2 rounded-2xl p-10 border-[#D1C7BE]  relative mt-2'>
                        <img src="/comma.png" alt="" className='absolute -top-4 bg-[#FDF3EA]' />
                        <p className="font-['inter'] font-medium italic text-[16px] leading-[30px] tracking-[0%] align-middle">The team is so knowledgeable and beyond helpful. I’m blown away by their communication, detail, and attentiveness and always feel like they have our best interest in mind. Definitely worth a try.</p>
                        <div className='flex justify-between'>
