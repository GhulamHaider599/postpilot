    ...
    <Container className='py-20' >
      <div className='flex gap-[128px] mb-15' id='contact'  >
        <div className='w-[30%] '>
          ...
          <p className='mt-3 text-black'>Our paper is sourced from FSC-certified mills. We plant enough trees to more than double our paper usage.</p>
        </div>

        <div className='w-[20%]'>
          <h5 className='py-2 font-bold text-black'>COMPANY</h5>
        ...
        <div className='w-[30%] '>
          <h5 className='py-2 font-bold text-black'>CONTACT</h5>
          <div className='flex flex-col gap-3'>

            <p className='flex text-black'>
              <img src="/email.png" alt="" className='mr-2' />
              support@postpilot.com</p>
            <p className='text-black'>Printed with ❤️️️ at our facility in South Carolina.</p>
          </div>
        </div>
      </div>
      ...
      <div className='flex justify-between my-4'>
        <div>
          ...
          <p className='text-black'>© 2022 PostPilot, Inc. All rights reserved.</p>
        </div>
